...
namespace CosmeticShop.Migrations
{
    ...
    [Migration("20210515164509_RemovedEntityOrderProcessingAddDeliveryDateToOrder")]
    partial class RemovedEntityOrderProcessingAddDeliveryDateToOrder
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CosmeticShop.Models.Products.Order", b =>
                {
                    ...
                    b.Property<int?>("OrderToCollectId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("OrderToCollectId")
                        .IsUnique()
                        .HasFilter("[OrderToCollectId] IS NOT NULL");

                    b.HasIndex("OrdersToDeliveryId")
                        .IsUnique()
                        .HasFilter("[OrdersToDeliveryId] IS NOT NULL");
            ...
            modelBuilder.Entity("CosmeticShop.Models.Products.OrderToCollect", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("CosmeticShop.Models.Products.OrderToDelivery", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
